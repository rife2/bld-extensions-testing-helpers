 ...
 * <p>
 * To use this resolver, register it with your test class:
 * <pre>{@code
 ...
 * @since 1.0
 */
public class RandomRangeResolver implements ParameterResolver {
    /**
     ...
     * @throws ParameterResolutionException if the annotation is missing, or if {@code min} > {@code max}
